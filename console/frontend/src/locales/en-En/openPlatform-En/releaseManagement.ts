const translation = {
  releaseManagement: {
    ...
    workflow: 'Workflow',
    virtual: 'Virtual',
    publishApproval: 'Publish Approval',
    agentId: 'Agent ID',
    ...
    approve: 'Approve',
    reject: 'Reject',
    approveApproval: 'Approve Publish Approval',
    rejectApproval: 'Reject Publish Approval',
    cancelApproval: 'Cancel Publish Approval',
    cancelApprovalShort: 'Cancel',
    cancelApprovalSuccess: 'Canceled successfully',
  ...
  releaseModal: {
    ...
    submitApprovalPending:
      'Submitted for publish approval. It will be published after an admin or owner approves it.',
    unBindTip: 'Unbind',
    unBindTipDesc:
