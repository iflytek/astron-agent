const translation = {
  ...
  save: '保存',
  agentBaseInfo: '基础信息',
  agentAppearanceVoice: '外观声音',
  search: '搜索',
  config: '配置',
  loading: '加载中...',
  debugHistory: '对话历史',
  noDebugHistory: '暂无调试历史',
  currentConfigValid: '当前配置有效',
  debugHistoryPersistTip:
    '使用当前智能体配置开始调试，会保存到当前智能体的服务端调试历史',
  editAgentConfigTip: '编辑当前智能体配置，保存后即可用于新调试会话',
  searchDebugHistory: '搜索调试历史',
  searchDebugHistoryTip: '输入关键词搜索当前智能体的调试历史',
  ...
  memory: {
    mem0Title: '云端记忆',
    mem0Description: '当前用于 Agent 对话的长期记忆服务',
    connected: '已接入',
    zepTitle: '会话记忆',
    zepDescription: '预留接入位，后续可复用同一配置面板',
    langMemTitle: '框架记忆',
    langMemDescription: '预留接入位，不影响当前 Mem0 配置',
    pendingConnection: '待接入',
    apiKeyRequired: '请填写 Mem0 API Key',
    saveConfigFailed: '保存记忆配置失败',
    deleted: '已删除',
    deleteFailed: '删除记忆失败',
    cleared: '已清空',
    clearFailed: '清空记忆失败',
    createAgentFirst: '请先创建智能体',
    pendingSave: '待保存',
    configured: '已配置',
    notConfigured: '未配置',
    highScoreHint: '当前阈值偏高，Mem0 常见得分在 0.1-0.4，可能导致检索不到。',
    scoreHint: '建议 0.1 左右；设为 0 表示不过滤低分结果。',
    service: '记忆服务',
    futureProviderSlot: '后续框架接入位',
    mem0CloudMemory: 'Mem0 云端记忆',
    mem0CloudMemoryDesc: '用于 Agent 对话的长期记忆写入、检索和管理。',
    enabled: '已启用',
    disabled: '未启用',
    connectionConfig: '连接配置',
    keyPrivacyTip: 'Key 只用于服务端调用，不回显明文。',
    enableMem0: '启用 Mem0',
    enableMem0Desc: '开启后，Agent 对话完成时写入记忆。',
    saved: '已保存',
    replace: '替换',
    apiKeyPlaceholder: '输入 Mem0 API Key',
    cancelReplace: '取消替换',
    retrievalPolicy: '检索策略',
    retrievalPolicyDesc: '影响每次 Agent 回复前注入的长期记忆。',
    autoSearch: '自动检索',
    autoSearchDesc: '每次用户提问前按当前问题搜索记忆。',
    searchTopK: '检索条数',
    minScore: '匹配阈值',
    memoryList: '记忆列表',
    clearMemories: '清空记忆',
    clearConfirm: '确认清空当前智能体作用域下的 Mem0 记忆？',
    clear: '清空',
    noMemories: '暂无记忆',
    deleteMemory: '删除记忆',
