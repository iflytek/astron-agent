const translation = {
  releaseManagement: {
    ...
    approve: '通过',
    reject: '拒绝',
    approveApproval: '通过发布审核',
    rejectApproval: '拒绝发布审核',
    cancelApproval: '撤销发布审核',
    cancelApprovalShort: '撤销',
    cancelApprovalSuccess: '撤销成功',
    approveSuccess: '审核通过，发布已执行',
    rejectSuccess: '已拒绝',
    reviewComment: '审核意见',
    confirm: '确认',
    refresh: '刷新',
  ...
  releaseModal: {
    ...
    submitApprovalPending: '已提交发布审核，管理员或所有者通过后将自动发布',
    unBindTip: '确定解除绑定？',
