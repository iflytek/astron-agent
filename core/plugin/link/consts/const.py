...
from plugin.link.consts.keys.common_keys import (
    ...
    JWT_AUDIENCE_KEY,
    JWT_AUTH_ENABLE_KEY,
    JWT_AUTH_EXCLUDE_PATHS_KEY,
    JWT_AUTH_HEADER_KEY,
    JWT_ISSUER_KEY,
    JWT_JWKS_URL_KEY,
    JWT_SHARED_SECRET_KEY,
    OAUTH2_AUDIENCE_ENV_KEY,
    OAUTH2_AUDIENCE_KEY,
    OAUTH2_CLIENT_ID_ENV_KEY,
    OAUTH2_CLIENT_ID_KEY,
    OAUTH2_CLIENT_SECRET_ENV_KEY,
    OAUTH2_CLIENT_SECRET_KEY,
    OAUTH2_SCOPE_ENV_KEY,
    OAUTH2_SCOPE_KEY,
    OAUTH2_TOKEN_URL_ENV_KEY,
    OAUTH2_TOKEN_URL_KEY,
    OFFICIAL_TOOL_KEY,
